...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // REMOVIDO: const recomecarAgendamentoFixedButton = document.getElementById('recomecar-agendamento-fixed-button'); // Este será dinâmico
    ...
    function sendMessage(message, displayMessage = null) {
        ...
        .then(data => {
            ...
            // REMOVIDO: Lógica de recarga automática aqui. O backend agora gerencia a navegação.
        })
        .catch(error => {
    ...
    // REINTRODUZIR O BOTÃO 'RECOMEÇAR AGENDAMENTO' AQUI, SE DESEJADO FIXO.
    // Por enquanto, ele será dinâmico no backend.
